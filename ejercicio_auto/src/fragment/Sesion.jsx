    ...
    const onSubmit = (data) => {
        ...
        InicioSesion(datos).then((info) => {
            ...
            if (info.code !== 200) {
                ...
                // console.log("aqui se ve el token: ", info.data.token)
                    ...
                    <div className="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
                                <p className="lead fw-normal mb-0 me-3">Iniciar Sesion con</p>
                            ...
                            <div className="d-flex justify-content-between align-items-center">
                                ...
                                <a href="#!" className="text-body">Olvido su clave?</a>
                            </div>

                            <div className="text-center text-lg-start mt-4 pt-2">
                                <button type="Submit" className="btn btn-primary btn-lg"
                                    style={{ paddingLeft: '2.5rem', paddingRight: '2.5rem' }} >Iniciar Sesion</button>
